...
//        bottomview.loadUrl("http://www.baidu.com");
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        topview.layout(0, 0, getScreenWidth(context), getScreenHeight(context)- CommonUtils.dip2px(context, 53)- CommonUtils.dip2px(context, 80));
        bottomview.layout(0, getScreenHeight(context)- CommonUtils.dip2px(context, 53)- CommonUtils.dip2px(context, 80), getScreenWidth(context), getScreenHeight(context)*2- CommonUtils.dip2px(context, 53)*2- CommonUtils.dip2px(context, 80)*2);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                if (currentPage==1) {
                    scroller.startScroll(0, (startY-(int) event.getY()), 0, getScreenHeight(context)- CommonUtils.dip2px(context, 53)- CommonUtils.dip2px(context, 80)-(startY-(int) event.getY()), 1000);
                    currentPage=2;
                    postInvalidate();
                }
                else if (currentPage==2) {
                    scroller.startScroll(0, getScreenHeight(context)- CommonUtils.dip2px(context, 53)- CommonUtils.dip2px(context, 80)-((int) event.getY()-startY), 0, -(getScreenHeight(context)- CommonUtils.dip2px(context, 53)- CommonUtils.dip2px(context, 80)-((int) event.getY()-startY)), 1000);
                    currentPage=1;
                    postInvalidate();
                }
                break;
