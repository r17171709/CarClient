...
public class SearchCarTypeAdapter extends RecyclerView.Adapter<SearchCarTypeAdapter.SearchCarTypeViewHolder> {
    ...
    @Override
    public void onBindViewHolder(SearchCarTypeViewHolder holder, int position) {
        ...
        if (getItemViewType(position)==TITLE) {
            ...
            holder.adapter_searchcartype_text.setText(((SearchCarTypeModel) models.get(position)).getTitle());
